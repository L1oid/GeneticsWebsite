...
import { solveQuestionnaire } from "../../../../state/slices/content/asyncActions";
                                ...
                                {question.questionType === SELECT && (
                                    <div>
                                        ...
                                        {getAnswersForQuestion(question.questionId).map((answer, answerIndex) => (
                                            <div key={answerIndex}>
                                                <input className="questionnaire-card-checkbox"
                                                       type="checkbox"
                                                       ...
                                                       onChange={(e) => {
                                                           ...
                                                           handleInputChange(question.questionId, isChecked ? '' : e.target.value);
                                                       }}
                                                />
                                                <label className="questionnaire-card-checkbox-label"
